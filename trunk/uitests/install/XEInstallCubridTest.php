...
class XEInstallCubridTest extends PHPUnit_Framework_TestCase
{
	...
	protected static $errorScreenFile = './install.cubrid.error.png';
	protected static $property = './install.cubrid.properties';
	 ...
	 */
	public function testInputDatabaseinformationCubrid()
	{
		$act = self::$oXESelenium->getElementValue('xpath', '/html/body/div/div[2]/div[2]/form/input[5]');
	...
	/**
	 * @depends testInputDatabaseinformationCubrid
	 */

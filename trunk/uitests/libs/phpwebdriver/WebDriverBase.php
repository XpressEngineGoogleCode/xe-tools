...
require_once $path . 'WebElement.php';
require_once $path . 'WebDriverResponseStatus.php';
require_once $path . 'WebDriverException.php';
require_once $path . 'NoSuchElementException.php';

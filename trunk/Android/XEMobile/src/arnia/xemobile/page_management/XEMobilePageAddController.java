...
public class XEMobilePageAddController extends XEFragment implements
		OnClickListener {
	// UI references
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.xemobilepageaddlayout, container,
				false);

		pageName = (EditText) view.findViewById(R.id.XEMOBILE_ADDPAGE_PAGENAME);
		browserTitle = (EditText) view
				.findViewById(R.id.XEMOBILE_ADDPAGE_BROWSERTITLE);

		layoutSpinner = (Spinner) view
				.findViewById(R.id.XEMOBILE_ADDPAGE_LAYOUTSPINNER);
		adapter = new ArrayAdapter<String>(this.activity,
				android.R.layout.simple_spinner_item);

		saveButton = (Button) view
				.findViewById(R.id.XEMOBILE_ADDPAGE_SAVEBUTTON);

		saveButton.setOnClickListener(this);

		pageType = (Spinner) view
				.findViewById(R.id.XEMOBILE_ADDPAGE_PAGETYPESPINNER);
	...
	private class AddPageAsyncTask extends AsyncTask<String, Object, Object> {
		...
		protected Object doInBackground(String... param) {
			...
			XELayout layout = listLayouts.layouts.get(layoutSpinner
					.getSelectedItemPosition());
		...
		protected void onPostExecute(Object result) {
			...
			try {
				...
				responseConfirmation = serializer.read(XEResponse.class,
						reader, false);
			} catch (Exception e) {
				e.printStackTrace();
			}

...
public class XEMobilePageTextEditor extends XEMobileTextEditor
{
	...
	private class GetPageContentAndTitleAsyncTask extends AsyncTask<Object, Object, Object>
	{
		...
		{
			responseContent = XEHost.getINSTANCE().getRequest("/index.php?module=mobile_communication&act=procmobile_communicationArticleContent&srl=" + document_srl);
			responseTitle = XEHost.getINSTANCE().getRequest("/index.php?module=mobile_communication&act=procmobile_communicationArticleTitle&srl=" + document_srl);			
			return null;
		}
	...
	private class SavePageAsyncTask extends AsyncTask<Object, Object, Object>
	{
		...
		protected Object doInBackground(Object... params) 
		{
			...
			String xmlRequest = "<?xml version=\"1.0\" encoding=\"utf-8\" ?>\n" +
					...
					"<error_return_url><![CDATA[/index.php?mid=" + "&act=dispPageAdminContentModify]]></error_return_url>\n" +
					"<act><![CDATA[procPageAdminArticleDocumentInsert]]></act>\n" +
					"<mid><![CDATA[" + mid +"]]></mid>\n" +
					"<content><![CDATA["+ content +"]]></content>\n" +
					"<document_srl><![CDATA["+ document_srl +"]]></document_srl>\n" +
					"<title><![CDATA["+ title +"]]></title><module><![CDATA[page]]></module><" +
					"/params></methodCall>";

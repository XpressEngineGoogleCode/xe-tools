...
public class XEMobileTextylePostsController extends XEActivity implements OnCheckedChangeListener, OnClickListener, OnItemClickListener
{
	// UI references
	private RadioButton savedPostsOption;
	private RadioButton publishedPostsOption;
	private ListView listView;
	private ArrayAdapter<XETextylePost> adapter;
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		adapter = new ArrayAdapter<XETextylePost>(this, android.R.layout.simple_list_item_1);
	...
	//async task for saved posts
	private class GetSavedPostsAsyncTask extends AsyncTask<String, Object, Object>
	{
		String response;
		...
		protected Object doInBackground(String... params) 
		{
			...
			response = XEHost.getINSTANCE().getRequest("/index.php?module=mobile_communication" +
					"&act=procmobile_communicationTextylePostList&module_srl=" + textyle.module_srl +
					"&published=-1");
		...
		protected void onPostExecute(Object result) 
		{
			...
			if(isLoggedIn(response, XEMobileTextylePostsController.this))
			{
				...
				//when the request for saved posts is finished, the task that gets the published posts starts
	...
	private class GetPublishedPostsAsyncTask extends AsyncTask<Object, Object, Object>
	{

		@Override
		protected Object doInBackground(Object... params) 
		{
			String response = XEHost.getINSTANCE().getRequest("/index.php?module=mobile_communication" +
					"&act=procmobile_communicationTextylePostList&module_srl=" + textyle.module_srl +
					"&published=1");
			...
			try
			{
				publishedPosts = serializer.read(XEArrayList.class, reader, false);
			}catch (Exception e) {
				e.printStackTrace();
			}
		...
		{
			super.onPostExecute(result);
			if(publishedPosts.posts == null) publishedPosts.posts = new ArrayList<XETextylePost>();
			if(publishedPostsOption.isChecked() ) setThePublishedPostsInAdapter();
		}
	}
	...
	public void setTheSavedPostsInAdapter()
	{
		...
		{
			Toast toast = Toast.makeText(getApplicationContext(), "No saved posts!", Toast.LENGTH_SHORT);
			toast.show();
		}
	...
	public void setThePublishedPostsInAdapter()
	{
		...
		{
			Toast toast = Toast.makeText(getApplicationContext(), "No published posts!", Toast.LENGTH_SHORT);
			toast.show();
		}
	...
	{
		Intent intent = new Intent (XEMobileTextylePostsController.this,XEMobileTextyleAddPostController.class);

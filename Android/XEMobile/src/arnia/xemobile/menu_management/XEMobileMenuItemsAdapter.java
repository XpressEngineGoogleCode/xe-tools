...
public class XEMobileMenuItemsAdapter extends BaseAdapter implements
		OnClickListener {
	...
	public void setWholeMenuItemsOfAMenu(
			ArrayList<XEMenuItem> arrayWholeMenuItems) {
		this.arrayWholeMenuItems = arrayWholeMenuItems;
	}

	// constructor
	public XEMobileMenuItemsAdapter(Context context, String menuitemParentSRL,
			String menuSRL) {
	...
	private class OrderMenuItemAsyncTask extends
		...
		private String requestedParamForSavingMenuOrder(
				ArrayList<XEMenuItem> wholeMenuItems, String parentSRL) {
			String result = "";
		...
		protected void onPostExecute(Object result) {
			...
			try {
				XEResponse confirmation = serializer.read(XEResponse.class,
						reader, false);

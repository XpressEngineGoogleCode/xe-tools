	...
	public View getView(int position, View convertView, ViewGroup arg2) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(
					R.layout.xemobilecommentitemcellview, null);
		}

		TextView nickname = (TextView) convertView
				.findViewById(R.id.XEMOBILE_TEXTYLE_COMMENTS_NICKNAMETEXTVIEW);
		...
		Button delete = (Button) convertView
				.findViewById(R.id.XEMOBILE_TEXTYLE_COMMENTS_DELETE);
		delete.setTag(position);
		delete.setOnClickListener((OnClickListener) context);

		Button visibility = (Button) convertView
				.findViewById(R.id.XEMOBILE_TEXTYLE_COMMENTS_PUBLIC);
